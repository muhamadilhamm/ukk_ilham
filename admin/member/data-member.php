...
if (isset($_POST["search"])) {
    $datasiswa = searchMember($_POST["keyword"]);
}
?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="width:200px;">
                                            <div>
                                            <a href="editMember.php?nisn=<?= $item['nisn'];?>" Class="btn btn-warning mt-2" style="width:100px;">Edit</a>
                                            </div>
                                            <div>
                                            <a href="deleteMember.php?nisn=<?= $item['nisn']; ?>" Class="btn btn-danger mt-2" style="width:100px;" onclick="return confirm('Apakah Member dengan Nama <?= $item['nama']; ?> ingin anda hapus?');">Hapus</a>
                                        </div>
                                    </td>
                                    </tr>
                                <?php endforeach; ?>
